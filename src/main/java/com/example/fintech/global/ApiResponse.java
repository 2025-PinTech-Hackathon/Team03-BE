package com.example.fintech.global;

import com.example.fintech.global.code.BaseCode;
import com.example.fintech.global.code.BaseErrorCode;
import com.example.fintech.global.code.ReasonDTO;
import com.example.fintech.global.code.base.SuccessCode;
...
public class ApiResponse<T> {
    ...
    public static <T> ApiResponse<T> onFailure(BaseErrorCode errorReason) {
